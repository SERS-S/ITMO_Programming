...
set CLASSPATH=%APP_HOME%\lib\Server.jar;%APP_HOME%\lib\NetworkPackage.jar;%APP_HOME%\lib\logback-classic-1.4.11.jar;%APP_HOME%\lib\slf4j-api-2.0.9.jar;%APP_HOME%\lib\logback-core-1.4.11.jar
