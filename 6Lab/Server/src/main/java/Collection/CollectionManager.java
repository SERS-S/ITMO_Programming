...
public class CollectionManager {
  ...
  public CollectionManager(Vector<String[]> data_stats) throws IOException {
    ...
    for (int i = 0; i < data_stats.size(); ++i) {
      data_list.add(new SpaceMarine(data_stats.get(i)[0], data_stats.get(i)[1], data_stats.get(i)[2], data_stats.get(i)[3], data_stats.get(i)[4], data_stats.get(i)[5], data_stats.get(i)[6]));
    }
